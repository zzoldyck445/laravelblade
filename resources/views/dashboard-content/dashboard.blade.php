@section('title')
  Acorn Admin Template | Dashboards
@endsection
        ...
        <div class="container">
          ...
          <div class="card mb-2">
            <div class="card-body h-100">
              Dashboard pages contains different layouts to provide stats, graphics, listings, categories, banners and so on. They have various implementations
              of plugins such as Datatables, Chart.js, Glide.js and Plyr.js with alternative extensions.
            </div>
          </div>
          <!-- Content End -->
